// CycleWater Service Worker — v54
// Bump CACHE version whenever you deploy new files

const CACHE = 'cyclewater-v54';
// v54: autocomplete faster (150ms), remove slow cemetery/way Overpass queries, fix identity modal, Live Mode button icon
