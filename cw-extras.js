...
<div style="display:flex;gap:8px">
  ...
  window.cwWaterTabSave=function(){
    ...
    else if(window.S){const id='l_'+Date.now();window.S.commPts=window.S.commPts||[];window.S.commPts.push({id,lat:f._lat,lng:f._lng,water_type:type,notes:note,source:'community'});window.saveLocalPts?.();window.refreshLayers?.();}
