// CycleWater Service Worker — v63
// Bump CACHE version whenever you deploy new files

const CACHE = 'cyclewater-v63';
// v63: Water-tab add flow, fountain discovery, faster route fetch, route-local remove, search autocomplete
