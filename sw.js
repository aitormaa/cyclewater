// CycleWater Service Worker — v71
// Bump CACHE version whenever you deploy new files

const CACHE = 'cyclewater-v71';
// v71: August 3 stable baseline, bounded water fetch, popup closes after route-local remove, Water-tab map adding
