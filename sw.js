// CycleWater Service Worker — v70
// Bump CACHE version whenever you deploy new files

const CACHE = 'cyclewater-v70';
// v70: August 3 stable baseline, bounded water fetch, popup route-local remove action, Water-tab map adding
