// CycleWater Service Worker — v61
// Bump CACHE version whenever you deploy new files

const CACHE = 'cyclewater-v61';
// v61: fix mobile gap taps, GPX recent-route recovery, speed dirty state, hide first-water metric, robust arrows
