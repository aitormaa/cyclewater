// CycleWater Service Worker — v56
// Bump CACHE version whenever you deploy new files

const CACHE = 'cyclewater-v56';
// v56: direction arrows (safe separate source), fountain icon, remove duplicate pin, remove onboarding text, profile Supabase sync
