    ...
    if(!map.getLayer('route-arrows-l')){
      try{
        map.addLayer({id:'route-arrows-l',type:'symbol',source:'route-arrows',
          layout:{'symbol-placement':'point','text-field':'›','text-size':20,
            'text-rotate':['get','bearing'],'text-rotation-alignment':'map',
            'text-allow-overlap':true,'text-ignore-placement':true},
          paint:{'text-color':'#ffffff','text-halo-color':'#38BDF8','text-halo-width':2}});
