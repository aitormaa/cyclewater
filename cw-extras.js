...
<div class="card" style="margin-top:10px">
  ...
  function showProfileContent(){
    ...
    document.getElementById('cw-clear-btn')?.style && (document.getElementById('cw-clear-btn').style.display='none');
    updateProfileUI();
  }
  ...
  function setSheetState(sb,state){
    ...
    if(state==='peek'||state==='half'||state==='open'){
      _cwTab='panel'; // sync internal tab state — restores route layers
      showPanelContent();
      ...
      applyTabLayers(); // restore route + water layers on map
    }
