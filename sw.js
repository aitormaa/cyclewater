...
// v6 adds gamification.js
const CACHE = 'cyclewater-v6';
...
self.addEventListener('fetch', event => {
  ...
  // JS scripts: network first so updates propagate quickly.
  if (url.pathname.endsWith('/recent-routes.js') || url.pathname.endsWith('/gamification.js')) {
    event.respondWith(
  ...
  // Map tiles and libraries: cache first.
  if (
